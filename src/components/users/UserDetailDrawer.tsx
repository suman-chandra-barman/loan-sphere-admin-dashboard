...
import { X, UserX, UserCheck, Activity, Phone, Building2, MapPin, Briefcase } from "lucide-react";
      ...
      >
        ...
        <div className="bg-[#A31D1D] text-white p-6 relative">
          ...
          <div className="flex items-center gap-4.5 mt-2">
            ...
            <Avatar className="h-14 w-14 rounded-full border border-white/20 overflow-hidden shrink-0 shadow-sm">
              {user.profileImage && (
                <AvatarImage
              ...
              <AvatarFallback className="bg-white/10 text-white text-lg font-bold flex items-center justify-center">
                {user.initials}
              </AvatarFallback>
            </Avatar>
